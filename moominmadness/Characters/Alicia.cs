...
{
    class Alicia : Character
    {

        public Alicia(Texture2D texture, Vector2 position, PlayerIndex playerIndex, SpriteEffects spriteEffect, bool isCharacterSelect) : base(texture, position, playerIndex, spriteEffect, isCharacterSelect)
        {
            ...
            this.characterName = "Alicia";
            this.specialAbilityInfo = "Pools of Agony";
            ...
            idleAnimationPos = 0; shootAnimationPos = 105; runAnimationPos = 210;
        ...
        {
            spriteBatch.Draw(texture, position, new Rectangle(-10, 0, iconWidth - 3, iconHeight - 38), playerColor, 0, Vector2.Zero, 3, spriteEffect, FloatLayerCalculator());
        }
